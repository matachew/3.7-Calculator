...
button0 = tk.Button(main, text="0", bg="#24292e", padx=0, pady=0,  image=szdimg0, command=lambda: on_click(0), highlightthickness = 0, bd = 0) #footnote 1 at bottom about Lambda
...
button4 = Button(main, text="4", padx=20, pady=20, image=szdimg4, command=lambda: on_click(4))
button5 = Button(main, text="5", padx=20, pady=20, image=szdimg5, command=lambda: on_click(5))
button6 = Button(main, text="6", padx=20, pady=20, image=szdimg6, command=lambda: on_click(6))
button7 = Button(main, text="7", padx=20, pady=20, image=szdimg7, command=lambda: on_click(7))
button8 = Button(main, text="8", padx=20, pady=20, image=szdimg8, command=lambda: on_click(8))
button9 = Button(main, text="9", padx=20, pady=20, image=szdimg9, command=lambda: on_click(9))
